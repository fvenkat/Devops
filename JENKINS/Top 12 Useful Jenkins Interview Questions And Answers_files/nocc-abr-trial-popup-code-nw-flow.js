...
jQuery("#stepzero_form").on("click", "#stepzero_submit", function() {
	
jQuery("#stepzero_form").css("display","none");
jQuery("#mobile_form").css("display","block");
jQuery("#otp_frm").css("display","none");
jQuery("#email_frm").css("display","none");
});	

jQuery('#email_frm').on('submit', function (e) {
jQuery('input[type="submit"]').attr('disabled', true);
jQuery("#loader_display").css("display","block");
jQuery("#mobile_form").css("display","none");
jQuery("#otp_form").css("display","none");
var lgmt = jQuery("#mobile_number").val();
uem = encodeURIComponent(jQuery("#mb_user_email").val());
sg = jQuery("#suid").val();
...
jQuery('#mob_frm').on('submit', function (e) {
jQuery('input[type="submit"]').attr('disabled', true);
jQuery("#loader_display").css("display","block");
jQuery("#otp_form").css("display","none");
jQuery("#email_form").css("display","none");
var lg = jQuery("#mobile_number").val();
if(lg == '') {
jQuery("#loader_display").css("display","none");
jQuery('input[type="submit"]').attr('disabled', false);
...
jQuery('input[type="submit"]').attr('disabled', false);
jQuery('#mobile_form').css("display","none");
jQuery('#otp_form').css("display","block");
jQuery('#otp_frm').css("display","block");
...
jQuery(document).on('click', '#popup_resend_otp', function (e) {
jQuery('input[type="submit"]').attr('disabled', true);
jQuery("#loader_display").css("display","block");
jQuery("#mobile_form").css("display","none");
jQuery("#email_form").css("display","none");
...
jQuery('#otp_frm').on('submit', function (e) {
jQuery('input[type="submit"]').attr('disabled', true);
jQuery("#loader_display").css("display","block");
jQuery("#mobile_form").css("display","none");
jQuery("#email_form").css("display","none");
var lgm = jQuery("#mobile_number").val();
var lgotp = jQuery("#mobile_otp").val();
if(lgotp == '') {
jQuery("#loader_display").css("display","none");
jQuery('input[type="submit"]').attr('disabled', false);
jQuery("#second_step_error_new_2").css("display","block");
...
if(resp.error == "incorrectphone") {
jQuery('input[type="submit"]').attr('disabled', false);
jQuery('#mob_submit').attr('disabled', false);
jQuery('#otp_form').css("display","none");
jQuery('#mobile_form').css("display","block");
jQuery("#second_step_error_new_2").css("display","block");
jQuery('#second_step_error_new_2').html("<div class='alert alert-danger fade in' role='alert'><i class='fa fa-warning alert-danger'></i><span id='err_two_new_2'>Please enter a valid OTP.</span></div>");
...
jQuery('#otp_form').css("display","block");
//jQuery('#email_form').css("display","block");
//jQuery('#email_frm').css("display","block");
jQuery("#second_step_error_new_2").css("display","block");
...
jQuery('#email_frm_abr').on('submit', function (e) {
...
uem = encodeURIComponent(jQuery("#mb_header_user_email_abr").val());
sg = jQuery("#suid").val();
urlx = jQuery("#get_url").val();
